...
<head>
  ...
  <meta name="keywords" content="site, marchand, vetements, design, clean, modern, 2022, Tshirt, polo, couleur, francais, responsable, ecolo, atelierfrancais, atelier, francais, ecologie, environnement, chanvre, lin, laine, bio, France, bleu, blanc, rouge, fashion, luxe, fun, commerce, expansion, SILEO">

  <link rel="icon" type="image/x-icon" href="/images/icon/logo.ico">
  <title>L'Atelier Français - Accueil</title>
  ...
  <div class="header1">
    <div class="row d-flex flex-row justify-content-between">
      ...
      if (isset($_GET['login'])) {
        ...
        //Requete et récup
        $sql = "SELECT Prenom_client FROM client WHERE email_client='"."$email' ";
        $result = $conn->query($sql);

        while($row = $result->fetch_assoc()) {
          $nom = $row["Prenom_client"];
        }
        $_SESSION['nom'] = $nom;
      }
      ?>
      <!-- Ligne à copier pour afficher bonjour x -->
      <?php
...
<body>
  ...
  <video style="width: 100vw; margin-bottom: -6px;" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
